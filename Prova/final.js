...
function setup() {
  ...
  */
  myVida.setActiveZonesNormFillThreshold(0.2);
  /*
    ...
    resolution.
  */
  var padding = 0.015; var n = 7;
  var zoneWidth = 0.12; var zoneHeight = 0.7;
...
/*
  points = font.textToPoints('Prova01', 0, 0, 10, {
    sampleFactor: 5,
    simplifyThreshold: 0
  });
  bounds = font.textBounds(' Prova01 ', 0, 0, 10);
  */
}
